<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderSummaryReport.aspx.cs" Inherits="iBargainReport.OrderSummaryReport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="752px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1037px">
                <LocalReport ReportEmbeddedResource="iBargainReport.rptOrderSummaryReport.rdlc" ReportPath="rptOrderSummaryReport.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="DataSet1TableAdapters.RptOrderSummaryTableAdapter">
                <SelectParameters>
